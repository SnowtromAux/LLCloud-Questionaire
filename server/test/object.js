...
const field2 = new NumberField("Na kolko godini si", [
  { option: [0 , 18], page_path: "/dete" },
  { option: [18 , 120], page_path: "/vuzrasten" }
]);

const page1 = new Page([field1, field2]);

const field3 = new OptionsField("Kude Jiveesh", [
	{ option: "Varna", page_path: "/varan" },
	{ option: "Sofia", page_path: "/sofianec" },
	{ option: "Burgas", page_path: "/burgaskabatka" }
]);

const page2 = new Page([field3]);

const field4 = new OptionsField("Kakuv pol si", [
	{ option: "Momche", page_path: "/he" },
	{ option: "Momiche", page_path: "/she" },
	{ option: "Drugo", page_path: "/it" }
]);
